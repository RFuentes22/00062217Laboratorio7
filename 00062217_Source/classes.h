...
enum parameters {THAO,KAPPA,LAMBDA,PHI,DELTA,ETA};
...
class mesh{
    ...
    public:
        void setParameters(float thao,float kappa, float lambda, float phi, float delta, float eta){
            parameters[THAO]=thao;
